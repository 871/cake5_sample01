...
final class PageAccessLogMapper
{
    ...
    public function toDomainEntity(OrmEntity $ormEntity): DomainEntity
    {
        return new DomainEntity(
            ...
            accessed: StrictCast::toString($ormEntity->accessed->format('Y-m-d\TH:i:s.u')),
            account_type: StrictCast::toString($ormEntity->account_type),
            account_id: StrictCast::toString($ormEntity->account_id),
            method: StrictCast::toString($ormEntity->method),
            path: StrictCast::toString($ormEntity->path),
