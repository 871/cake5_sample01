...
final class Mapper
{
    ...
    /**
     * @param OrmEntityGrantPermission $ormGrantPermission
     * @return DomainEntityGrantPermission
     */
    public static function toDomainGrantPermission(OrmEntityGrantPermission $ormGrantPermission): DomainEntityGrantPermission
    {
