...
final class Edit implements ServiceInterface
{
    ...
    public function startInputProcess(): InputProcess
    {
        ...
        $process = $processFactory->start(
            ...
            processParams: new ProcessParams([
                ...
                'login_id' => $adminAccount->loginId()->toString(),
                'name' => $adminAccount->name()->toString(),
                'email' => $adminAccount->email()->toString(),
                'password' => '',
                'role_id' => $adminAccount->roleId()->toString(),
                'status' => $adminAccount->status()->toString(),
            ]),
        );
    ...
    public function saveInputProcess(): self
    {
        ...
        $changePassword = !empty($input['password']);

        (new AdminAccountsRepository())->update(
            new AdminAccount(
                ...
                password: $changePassword ? Cast::toString($input['password']) : null,
