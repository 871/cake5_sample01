...
namespace App\Application\Controller\Admin\UserAccount\Shared;
    ...
    public function id(Validator $validator): self
    {
        ...
        $validator
            ...
            ->add('id', [
                ...
                'exists' => [
                    'rule' => function (string $value) {
                        /** @var \App\Model\Table\User\UserAccountsTable $table */
                        $table = $this->fetchTable(UserAccountsTable::class);
