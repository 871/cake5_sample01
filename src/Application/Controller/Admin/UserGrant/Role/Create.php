...
use App\Domain\User\UserGrant\Entity\GrantRolePermission;
...
final class Create implements ServiceInterface
{
    ...
    private function getValidator(): Validator
    {
        ...
        /** @var \App\Application\Controller\Admin\UserGrant\Role\Shared\ValidatorSetting $validatorSetting */
    ...
    public function saveInputProcess(): self
    {
        ...
        (new UserGrantRoleRepository($this->datetime))->create(new GrantRole(
