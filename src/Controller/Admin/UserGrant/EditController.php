...
use App\Application\Controller\Admin\UserGrant\Edit as CtlService;
...
{
    /**
     * @var \App\Application\Controller\Admin\UserGrant\Edit
     */
    ...
    public function input()
    {
        ...
        return $this->render('/Admin/UserGrant/input');
    }
    ...
    public function conf()
    {
        ...
        return $this->render('/Admin/UserGrant/conf');
    }
    ...
    public function confPost()
    {
        try {
            ...
            $this->Flash->success(__('ユーザ権限の更新が完了しました。'));
