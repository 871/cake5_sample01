...
use App\Application\Controller\Admin\UserAccount\Edit as CtlService;
...
{
    /**
     * @var \App\Application\Controller\Admin\UserAccount\Edit
     */
    ...
    public function confPost()
    {
        try {
            ...
            $this->Flash->success(__('ユーザアカウントの更新が完了しました。'));
