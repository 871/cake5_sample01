...
use App\Application\Controller\Admin\UserAccount\Create as CtlService;
...
{
    /**
     * @var \App\Application\Controller\Admin\UserAccount\Create
     */
    ...
    public function input()
    {
        ...
        return $this->render('/Admin/UserAccount/input');
    }
    ...
    public function conf()
    {
        ...
        return $this->render('/Admin/UserAccount/conf');
    }
    ...
    public function confPost()
    {
        try {
            ...
            $this->Flash->success(__('ユーザアカウントの作成が完了しました。'));
